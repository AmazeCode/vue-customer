<template>
  <div class="edit container">
      ...
      <router-link class="btn btn-default" v-bind:to="'/customer/'+this.$route.params.id">返回</router-link>
      ...
      <form v-on:submit="updateCustomer">
          <div class="well">
              ...
              <div class="form-group">
                  <label>个人简介</label>
                  <!-- <input type="text" class="from-control" placeholder="profile" v-model="customer.profile"/> -->
